...
public class DynamicBeat extends JFrame { // GUI 기반의 프로그램을 만들기 위해 가장 기본적으로 상속받아야 하는 것
	...
	private Image titleImage = new ImageIcon(Main.class.getResource("../images/bomsarangTitle.png")).getImage();
	private Image selecetedImage = new ImageIcon(Main.class.getResource("../images/bomsarang2.jpg")).getImage();
	...
	public void screenDraw(Graphics g) {
		...
		if(isMainScreen) {
			g.drawImage(selecetedImage, 340, 100, null);
